...
export const Cart: React.FC = () => {
  ...
  return (
    <div className="fixed w-full h-screen top-0">
      <div className="w-[400px] h-[300px] shadow-lg bg-secondary-50 rounded-xl relative top-2/4 left-2/4 transform -translate-x-1/2 -translate-y-1/2">
        <div className="p-5 h-full">
          <div className="absolute right-3 top-3 cursor-pointer z-[60]">
            <svg
            ...
            {cartItems?.map((items: CartItemInterface) => (
              <>
                {items?.notes.map((item, index) => (
                  <div
                    className="px-3 py-5 flex items-center justify-between rounded-lg bg-white-50 cursor-default relative shadow-sm overflow-hidden cart_menu-item"
                    key={index}
                  >
