...
import { fetchAddNoteCart, fetchDeleteNote } from '../../../redux/slice/noteSlice';
...
export const Control: React.FC<ControlTypes> = ({ name, username, controlCords, id, setIsControl}) => {
        ...
        <div className='absolute left-[195px] w-[225px] bg-white box-shadow z-50' onClick={(e) => e.stopPropagation()} style={{top: controlCords.y}}>
            <div className=''>
                ...
                <div className='p-2 px-0'>
                    <div className='flex items-center ml-1 mr-1 pt-1 pb-1 px-3 cursor-default rounded text-base hover:bg-white-2' onClick={() => addNoteToCart()}>
