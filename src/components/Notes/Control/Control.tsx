...
export const Control: React.FC<ControlTypes> = ({
  ...
  return (
    <div
      className="absolute left-[195px] w-[225px] bg-white box-shadow z-50"
    ...
    >
      <div className="">
        ...
        <div className="p-2 px-0">
          <div
            className="flex items-center ml-1 mr-1 pt-1 pb-1 px-3 cursor-default rounded text-base hover:bg-white-2"
            onClick={() => addNoteToCart()}
          >
            <svg
          ...
          <div className="flex items-center ml-1 mr-1 pt-1 pb-1 px-3 cursor-default rounded text-base hover:bg-white-2">
            ...
            >
              <path
                d="M12.6587 1.34134L14.6587 3.34134L13.134 4.86667L11.134 2.86667L12.6587 1.34134ZM5.33334 10.6667H7.33334L12.1913 5.80867L10.1913 3.80867L5.33334 8.66667V10.6667Z"
                fill="#676767"
              />
              <path
          ...
          <div className="px-4 text-sm text-light-gray2">
            <div>Page: {name}</div>
            <div className="">
              Last edited by <span className="capitalize">{username}</span>
            </div>
