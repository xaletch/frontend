              ...
              >Открыть доступ для чтения</button>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex cursor-default items-center gap-2 bg-secondary-100 rounded-md p-2 px-3 h-[36px]">
                    <Link to={`https://kotion-note.netlify.app/document/read/${id}`} target="blank" className="text-sm font-normal text-secondary-550">https://kotion-note.netlify.app/document/read/{id && id.slice(0,8)}...</Link>
