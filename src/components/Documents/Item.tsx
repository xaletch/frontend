...
export const Item: React.FC<DocType> = ({ _id, name, smile, handleSelectNote }) => {
    return (
        <div className='px-1'>
            {/* onDoubleClick={handleUpdate} onClick={() => handleSelectNote(id)} */}
            <div className={`page p-1 px-3 h-8 flex items-center justify-between font-medium cursor-pointer hover:bg-light-grey relative`} onClick={() => handleSelectNote(_id)}>
