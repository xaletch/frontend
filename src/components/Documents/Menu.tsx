...
import { Buttons } from "../MenuButtons/buttons";
...
export const Menu: React.FC<MenuInterface> = ({
  ...
  return (
    <div
      className="w-full h-full flex flex-col justify-between pb-12 "
      ref={navbarRef}
    >
      <div
      ...
      ></div>
      <div>
        <MenuHead username={username} collapse={collapse} />
        ...
        <div className="">
          <Buttons
            ...
            handleClick={handleOpenSearchMenu}
          />
      ...
      <div className="mt-4 flex flex-col justify-between overflow-hidden">
        ...
        <div className="mt-4">
          <Buttons
            ...
            handleClick={handleOpenCartMenu}
          />
        </div>
      </div>
    </div>
